		...
		public function init() {
			...
			$this->strings = array(
				...
				'notice_can_activate_required'    => _n_noop(
					'The following required for AT News Scroller plugin is currently inactive: %1$s.',
					'The following required AT News Scroller plugins are currently inactive: %1$s.',
					'tgmpa'
				),
				'notice_can_activate_recommended' => _n_noop(
					'The following recommended AT News Scroller plugin is currently inactive: %1$s.',
					'The following recommended AT News Scroller plugins are currently inactive: %1$s.',
					'tgmpa'
				),
